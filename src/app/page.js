      ...
      <section className="relative w-full h-auto ">
        <div className="w-full h-auto flex gap-15 max-lg:flex-col max-lg:justify-center">
          ...
          <div className="relative w-[50%] max-lg:w-full max-lg:justify-center max-lg:flex">
            ...
            <img
              src="https://i-p.rmcdn.net/6169a98c239f1d001467eba5/5146291/image-e57ce5e6-2574-41c2-b0f3-7a376b239447.png?w=433&e=webp&nll=true"
              className="w-52 absolute top-[-20px] left-[30%] z-20 max-sm:w-36 max-sm:left-0 max-sm:top-0"
            />
            <img
              src="https://i-p.rmcdn.net/6169a98c239f1d001467eba5/5146291/image-0db7a7a0-6eb6-4c66-afef-eaf0c2a3b838.png?w=433&e=webp&nll=true"
              className="w-52 absolute top-44 left-[12vw] z-0 max-sm:w-36"
            />
            <img
              src="https://i-p.rmcdn.net/6169a98c239f1d001467eba5/5146291/image-558ef1cd-3f39-41a3-a26a-1bbe618a87e4.png?w=433&e=webp&nll=true"
              className="w-52 absolute top-[-90px] left-[26vw] z-0  max-sm:w-36"
            />
            <img
              src="https://i-p.rmcdn.net/6169a98c239f1d001467eba5/5146291/image-bb22ce71-9e22-41e6-ac38-71e9b528ad1a.png?w=433&e=webp&nll=true"
          ...
          <div className="relative flex top-28 w-[50%]  max-lg:w-full max-lg:justify-center max-lg:left-0 max-lg:top-28 max-xl:left-5 max-xl:top-44">
            ...
            <img
              src="https://i-p.rmcdn.net/6169a98c239f1d001467eba5/5146291/image-177dd55e-e715-4284-b969-21d3885a8fe9.png?w=433&e=webp&nll=true"
              className="w-52 absolute top-0 left-[20px] max-lg:left-[60px] z-10 max-sm:w-36"
            />
            <img
              src="https://i-p.rmcdn.net/6169a98c239f1d001467eba5/5146291/image-560655ee-6349-4491-97ad-3eb333f37ae4.png?w=433&e=webp&nll=true"
              className="w-52 absolute top-[-120px] right-[140px] z-0 max-sm:w-36"
            />
            <img
              src="https://i-p.rmcdn.net/6169a98c239f1d001467eba5/5146291/image-b4882ee6-9a76-4d9a-a2ad-37e5b3868afd.png?w=433&e=webp&nll=true"
        ...
        <div className="relative w-full max-lg:top-10">
          ...
          {/* img images */}
          <img
            src="https://i-p.rmcdn.net/6169a98c239f1d001467eba5/5146291/image-7667d2e5-137b-4ec8-986d-38ca1218e281.png?w=433&e=webp&nll=true"
            className="w-52 absolute top-28 left-10 z-0 max-sm:w-36"
          />
          <img
            src="https://i-p.rmcdn.net/6169a98c239f1d001467eba5/5146291/image-7ca2aee2-7b4b-4c1c-aeff-7892cd75c80e.png?w=433&e=webp&nll=true"
            className="w-52 absolute top-36 left-52 z-0 opacity-75 max-sm:w-36"
          />
          <img
      ...
      <section className="w-full h-auto flex flex-wrap justify-start items-center gap-5 mt-20">
        <div className="relative w-[49%] h-[1000px] flex flex-col justify-between border-2 border-[#D3D3D3] mt-10 max-lg:w-full">
          ...
          <div className=" w-full h-auto flex items-center justify-center">
            <img
              src="https://i-p.rmcdn.net/6169a98c239f1d001467eba5/5146291/image-136c2817-193b-4170-8397-2b27c242b5d5.png?e=webp&nll=true&cX=0&cY=0.5&cW=1368&cH=1182"
        ...
        <div className="relative w-[49%] h-[1000px] flex flex-col justify-between border-2 border-[#D3D3D3] mt-10 max-lg:w-full">
          ...
          <div className=" w-full h-auto flex items-center justify-center">
            <img
              src="https://i-p.rmcdn.net/6169a98c239f1d001467eba5/5146291/image-60810f65-1f66-440a-a5b9-4e7db2771219.png?w=1459&e=webp&nll=true"
